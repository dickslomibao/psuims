@include('admin.includes.header', ['title' => 'Department Management'])
        ...
        <div class="col-12">
            <div class="w-100 d-flex justify-content-between table-header-btn">
                ...
                <button class="btn-add-management" id="modal_btn" data-bs-toggle="modal" data-bs-target="#addCampusForm"><i
                        class="fa-solid fa-plus"></i> Add new Deparment</button>
            </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="addCampusFormLabel">Add new department</h1>
                ...
                <form method="POST" action="{{ route('store.department') }}">
                    ...
                    <div class="mb-3">
                        <div class="mb-3">
                            ...
                            <select class="form-select" name="college" required aria-label="Default select example">
