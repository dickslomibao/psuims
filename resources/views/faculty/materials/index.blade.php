@if (Auth::user()->type == 2)
    @include('admin.includes.header', ['title' => 'Evaluate Instructional Material'])
@else
    @include('faculty.includes.header', ['title' => 'Evaluate Instructional Material'])
@endif
                        ...
                        data: function(data, type, row) {
                            return `<div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li><a class="dropdown-item" href="/instructionalmaterials/evaluate/${data.id}/details">View Details</a></li>
