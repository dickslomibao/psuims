@include('faculty.includes.header', ['title' => 'View Score'])
<div class="container-fluid" style="padding: 20px;margin-top:50px">
    <div class="row">
        @for ($trial = 1; $trial <= $file->trial; $trial++)
            <div class="col-12">
                            ...
                            <div class="col-12">
                                ...
                                <table class="table table-bordered">
                                    <tr style="background: whitesmoke">
                                        ...
                                        <th style="width: 50%" colspan="{{ count($file->departmentEvaluator) }}">
                                            <center> Score</center>
                                        </th>
                                    </tr>
                                    <tr>
                                        ...
                                        @foreach ($file->departmentEvaluator as $key => $h_de)
                                            @php
                                                $comment = $file->getLogsScoreAttribute($h_de->user_id, $trial, 1);
                                            @endphp
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            @if ($comment)
                                                                <h6 style="margin: 20px 0 5px 0">Feed back:</h6>
                                                                <pre
...
word-wrap: break-word;">@php echo $comment->feedback;@endphp  
                                                                ...
                                                                <h6 class="mt-3">Date: {{ $comment->created_at }}
                                                                </h6>
                                                            @endif
                                                        </div>
                                                    </div>
                                    ...
                                    @foreach ($m->subCriteria as $sub)
                                        <tr>
                                            ...
                                            @foreach ($file->departmentEvaluator as $key => $b_de)
                                                @php
                                                    $score = $sub->getGetDeptEvaluatorAttribute($b_de->user_id, $trial);
                                                @endphp
                                                <td>
                                                    @if ($score)
                                                        {{ $score->score }}%
